...
`.trim(),p.createElement("div")),_=(a.appendChild(f),f.classList.add("sw-user-debug-action-wrapper"),p.createElement("div"));f.appendChild(_),_.classList.add("sw-user-debug-copy-btn"),_.innerText="Copy",_.onclick=()=>{y.classList.add("copying"),y.select(),p.execCommand("copy"),y.classList.remove("copying"),_.classList.add("success"),setTimeout(()=>{_.classList.remove("success")},240)},p.body.appendChild(u)}catch(e){g.Logger.warn(e)}})}}},"./src/sdk/services/user.service.ts":function(e,s,t){"use strict";var p=this&&this.__awaiter||function(e,r,p,l){return new(p=p||Promise)(function(t,s){function i(e){try{n(l.next(e))}catch(e){s(e)}}function o(e){try{n(l.throw(e))}catch(e){s(e)}}function n(e){var s;e.done?t(e.value):((s=e.value)instanceof p?s:new p(function(e){e(s)})).then(i,o)}n((l=l.apply(e,r||[])).next())})};Object.defineProperty(s,"__esModule",{value:!0}),s.UserService=void 0;const r=t("./src/sdk/services/helpers/user-profile.service-helpers.ts"),i=t("./src/sdk/models/events/subscriber-streamable-event.model.ts"),l=t("./src/sdk/data-providers/cookie.data-provider.ts"),o=t("./src/sdk/repositories/subscription.repository.ts"),u=t("./src/sdk/enums/event-type.enum.ts"),c=t("./src/_utils/global-env.ts"),n=t("./src/sdk/repositories/application.repository.ts"),d=t("./src/sdk/services/logging.service.ts"),a=t("./src/sdk/services/registration.service.ts");var h=t("./src/sdk/models/events/eventable.model.ts");const m=t("./src/sdk/models/events/event.model.ts"),v=t("./src/sdk/enums/trackable-setting.enum.ts"),y=t("./src/sdk/repositories/user.repository.ts"),f=t("./src/sdk/constants.ts"),_=t("./src/sdk/enums/steamable-event-type.enum.ts"),b=t("./src/sdk/utils.ts");class g extends h.EventableModel{constructor(){super(...arguments),this.userProfileEventsWired=!1}loadUser(e,i){return p(this,void 0,void 0,function*(){let e=yield y.UserRepository.get();var s=!e.puuid;let t;return i.env.inWorkerGlobalScope()||(t=i.env.getQueryString()[f.PUSHLY_UNIQUE_USER_ID_QS]),e.env=i.env,s&&(e.puuid=t||(0,b.randomString)()),e.puuid&&/undefined/i.test(e.puuid.toString())&&(e.puuid=(0,b.randomString)()),i.domain.isEventOnlyMode()||!(yield y.UserRepository.getPromptDismissedState())&&e.isDismissed()&&(e.subscriberState="none"),yield y.UserRepository.set(e),e})}reloadUserWithCachePriority(s){return p(this,void 0,void 0,function*(){var e=yield y.UserRepository.getWithCachePriority();return s.puuid=e.puuid||s.puuid,s.subscriberState=e.subscriberState||s.subscriberState,s.token=e.token||s.token,s})}wireProfileEvents(s){if(!this.userProfileEventsWired){this.userProfileEventsWired=!0;const e=[u.EventType.PROFILE_UPDATE,u.EventType.PROFILE_UPDATE_EXTERNAL_ID,u.EventType.PROFILE_UPDATE_USER_EVENT,u.EventType.PROFILE_UPDATE_TAGS,u.EventType.PROFILE_APPEND,u.EventType.PROFILE_REMOVE,u.EventType.PAGE_TAG_VISIT,u.EventType.VIEW_ITEM,u.EventType.SAVE_ITEM,u.EventType.ADD_TO_CART,u.EventType.UPDATE_CART_ITEM,u.EventType.PURCHASE,u.EventType.REQUEST_USER_DELETION];e.forEach(e=>{this._wireProfileEvent(s,e)})}}verifyUserSubscriptionState(r){return p(this,void 0,void 0,function*(){const s=r.env,e=r.domain,t=r.user;if(e.isEventOnlyMode())d.Logger.info("Skipping user subscription state verification while in event only mode");else{d.Logger.info("Verifying user subscription state");let e;(s.isHTTPS()||s.isDevMode())&&(e=yield r.user.getComputedPushPermission(r));var i=l.CookieDataProvider.get("_pnss"),o="subscribed"===(t.subscriberState=i),n="dismissed"===i;"blocked"===i?e&&"denied"!==e.permission?"granted"===e.permission&&e.host===(0,c.getSelf)().location.hostname?yield a.RegistrationService.performManualRegistrationAttempt(r,t.lastSeenPromptId):"default"===e.permission&&this.setSubscriptionState(t,"none"):("blocked"!==t.subscriberState&&(t.subscriberState="blocked"),this.dispatch(new m.EventModel(u.EventType.EXIT_PERMISSIONS_DENIED)),this.debugPromptNotShown(r,"user_permission_denied")):n?e&&"default"!==e.permission?"granted"===e.permission&&e.host===(0,c.getSelf)().location.hostname?yield a.RegistrationService.performManualRegistrationAttempt(r,t.lastSeenPromptId):"denied"===e.permission&&(yield this.setSubscriptionState(t,"blocked"),this.dispatch(new m.EventModel(u.EventType.EXIT_PERMISSIONS_DENIED)),this.debugPromptNotShown(r,"user_permission_denied")):("dismissed"!==t.subscriberState&&(t.subscriberState="dismissed"),this.dispatch(new m.EventModel(u.EventType.EXIT_PERMISSIONS_DISMISSED)),this.debugPromptNotShown(r,"user_permission_dismissed")):o?e&&"granted"!==e.permission?"default"===e.permission?(yield this.setSubscriptionState(t,"none"),yield a.RegistrationService.unsubscribe(r,"none")):"denied"===e.permission&&(t.token=null,yield a.RegistrationService.unsubscribe(r),this.dispatch(new m.EventModel(u.EventType.EXIT_PERMISSIONS_DENIED)),this.debugPromptNotShown(r,"user_permission_denied")):"subscribed"!==t.subscriberState&&(t.subscriberState="subscribed"):e&&"default"!==e.permission?"granted"===e.permission?(t.subscriberState="subscribed",e.host===(0,c.getSelf)().location.hostname&&(yield a.RegistrationService.performManualRegistrationAttempt(r,t.lastSeenPromptId))):"denied"===e.permission&&(yield this.setSubscriptionState(t,"blocked"),this.dispatch(new m.EventModel(u.EventType.EXIT_PERMISSIONS_DENIED)),this.debugPromptNotShown(r,"user_permission_denied")):"none"!==t.subscriberState&&(t.subscriberState="none")}"none"===t.subscriberState?d.Logger.info("Subscription state is currently set to none."):"subscribed"===t.subscriberState?d.Logger.info("Subscription state is currently set to subscribed."):"dismissed"===t.subscriberState?d.Logger.info("Subscription state is currently set to dismissed."):"blocked"===t.subscriberState&&d.Logger.info("Subscription state is currently set to blocked."),yield y.UserRepository.set(t)})}setExternalId(e,s){return p(this,void 0,void 0,function*(){e.externalId=s,yield y.UserRepository.set(e)})}saveExternalId(e,s){return p(this,void 0,void 0,function*(){yield this.setExternalId(e.user,s),yield r.UserProfileServiceHelpers.saveExternalUserId(e,s)})}setToken(e,s){return p(this,void 0,void 0,function*(){e.token=s,yield y.UserRepository.set(e)})}setSubscriptionState(e,s,t,i){return p(this,void 0,void 0,function*(){d.Logger.info("Updating subscriber state to "+s),e.subscriberState=s,t?e.token=t:t=null,yield y.UserRepository.set(e),"dismissed"===e.subscriberState&&i&&(yield y.UserRepository.setPromptDismissedState(e,i))})}setLastSeenPromptId(e,s){return p(this,void 0,void 0,function*(){e.lastSeenPromptId=s,yield y.UserRepository.set(e)})}setPromptState(e,s,t,i){return p(this,void 0,void 0,function*(){e.promptFcapSeconds=s,e.promptCountState=t,yield y.UserRepository.setPromptState(e,i)})}clearPromptFcapState(){return p(this,void 0,void 0,function*(){yield y.UserRepository.clearPromptState()})}setPromptDismissed(e,s){return p(this,void 0,void 0,function*(){yield y.UserRepository.setPromptDismissedState(e,s)})}setLastReferrerState(e,s){return p(this,void 0,void 0,function*(){e.lastReferrerState={referrer:s,lastSetAt:(new Date).getTime()},yield y.UserRepository.set(e)})}clearLastReferrerState(e){return p(this,void 0,void 0,function*(){delete e.lastReferrerState,yield y.UserRepository.set(e)})}handleUdrRequest(t){return p(this,void 0,void 0,function*(){var e=t.env,s=!!e&&!!l.CookieDataProvider.get("_pnudr");l.CookieDataProvider.set("_pnudr","1"),s?d.Logger.warn("User deletion has already been requested."):(yield this.post(new i.SubscriberStreamableEventModel(_.StreamableEventType.UDR,{},t)),yield o.SubscriptionRepository.unregister(t),n.ApplicationRepository.purgeCookies(),y.UserRepository.purgeCookies(),this.dispatch(new m.EventModel(u.EventType.USER_DELETION_REQUEST,void 0,t.app.loadConfig,e)))})}handleUdrRevert(){l.CookieDataProvider.clear("_pnudr")}_parseTrackableFlags(e){let s=[],t=Object.keys(v.TrackableSetting).map(e=>v.TrackableSetting[e]);return e&&("string"==typeof e&&(e=String(e).split(",").map(e=>e.toLowerCase().trim())),Array.isArray(e)&&0<e.length&&(s=e.map(e=>e.toLowerCase()).filter(e=>-1!==t.indexOf(e)))),s}processUdr(){return p(this,void 0,void 0,function*(){return y.UserRepository.purgeCookies()})}_wireProfileEvent(o,n){this.watch(n,t=>{const i=()=>p(this,void 0,void 0,function*(){if(o.app&&o.app.isLoaded)if(((yield o.user.getComputedPushPermission(o)).subscription||o.domain.isEventOnlyMode())&&(yield o.user.isSubscribed(o)))try{switch(n){case u.EventType.PROFILE_UPDATE:yield r.UserProfileServiceHelpers.saveUserProfileData(o,t);break;case u.EventType.PROFILE_UPDATE_EXTERNAL_ID:yield this.setExternalId(o.user,t),yield r.UserProfileServiceHelpers.saveExternalUserId(o,t);break;case u.EventType.PROFILE_UPDATE_USER_EVENT:yield r.UserProfileServiceHelpers.saveUserEvent(o,t);break;case u.EventType.PROFILE_UPDATE_TAGS:yield r.UserProfileServiceHelpers.saveUserTags(o,t);break;case u.EventType.PROFILE_APPEND:yield r.UserProfileServiceHelpers.appendProfileArrayValue(o,t);break;case u.EventType.PROFILE_REMOVE:yield r.UserProfileServiceHelpers.removeProfileArrayValue(o,t);break;case u.EventType.PAGE_TAG_VISIT:t=Array.isArray(t)?t:[t],yield r.UserProfileServiceHelpers.pageTagVisit(o,t);break;case u.EventType.VIEW_ITEM:yield r.UserProfileServiceHelpers.viewItem(o,t);break;case u.EventType.SAVE_ITEM:yield r.UserProfileServiceHelpers.saveItem(o,t);break;case u.EventType.ADD_TO_CART:yield r.UserProfileServiceHelpers.addToCart(o,t);break;case u.EventType.UPDATE_CART_ITEM:yield r.UserProfileServiceHelpers.updateCartItem(o,t);break;case u.EventType.PURCHASE:yield r.UserProfileServiceHelpers.purchase(o,t);break;case u.EventType.REQUEST_USER_DELETION:yield this.handleUdrRequest(o)}}catch(e){d.Logger.error(o,e)}else{let e=!0,s;if(n===u.EventType.PROFILE_UPDATE_EXTERNAL_ID?(s=t,e=!1):t instanceof Object&&"external_id"in t&&(s=t.external_id),s&&(yield this.setExternalId(o.user,s)),e){let e,s;e=this.watchOnce(u.EventType.REGISTRATION_SUBSCRIBED,()=>{s&&s(),i()}),s=this.watchOnce(u.EventType.REGISTRATION_MIGRATED,()=>{e&&e(),i()})}}else this.watchOnce(u.EventType.APPLICATION_LOADED,i)});i()})}}s.UserService=new g},"./src/sdk/services/worker.service.ts":function(e,s,t){"use strict";var o=this&&this.__awaiter||function(e,r,p,l){return new(p=p||Promise)(function(t,s){function i(e){try{n(l.next(e))}catch(e){s(e)}}function o(e){try{n(l.throw(e))}catch(e){s(e)}}function n(e){var s;e.done?t(e.value):((s=e.value)instanceof p?s:new p(function(e){e(s)})).then(i,o)}n((l=l.apply(e,r||[])).next())})};Object.defineProperty(s,"__esModule",{value:!0}),s.WorkerService=void 0;const n=t("./src/sdk/constants.ts"),r=t("./src/sdk/services/logging.service.ts"),i=t("./src/_utils/service-worker-registration.ts"),p=t("./src/sdk/models/events/event.model.ts"),l=t("./src/sdk/enums/event-type.enum.ts"),u=t("./src/sdk/repositories/application.repository.ts");var c=t("./src/sdk/models/events/eventable.model.ts");const d=t("./src/sdk/exceptions/worker-registration.exception.ts");class a extends c.EventableModel{_installPushlyServiceWorker(t){return o(this,void 0,void 0,function*(){const e=t.env.navigator;var s=(0,i.getPushlyWorkerConfig)(t);return e.serviceWorker.register(s.installationPath,{updateViaCache:"none",scope:s.scope})})}registerWorker(s){return o(this,void 0,void 0,function*(){let e=null;try{(e=yield(0,i.getPushlyServiceWorkerRegistration)(s))||(r.Logger.info("Registering new ServiceWorker"),e=yield this._installPushlyServiceWorker(s),this.dispatch(new p.EventModel(l.EventType.SW_INSTALLED,{registration:e}))),yield u.ApplicationRepository.set(s.app),this.dispatch(new p.EventModel(l.EventType.SW_SETUP_COMPLETE,{registration:e}))}catch(e){throw r.Logger.warn({type:e.type,code:e.code,message:e.message,error:e}),new d.WorkerRegistrationException(e)}return e})}loadServiceWorkerDependencyScript(i){return o(this,void 0,void 0,function*(){const e=i.env.document;if(e&&e.body){const s=e.createElement("script"),t=(s.onload=()=>{r.Logger.info("ServiceWorker dependency script loaded")},s.async=!0,s.src=n.SW_DEPENDENCY_URL,e.getElementsByTagName("script")[0]);t.parentNode.insertBefore(s,t)}})}}s.WorkerService=new a},"./src/sdk/utils.ts":(e,s,t)=>{"use strict";Object.defineProperty(s,"__esModule",{value:!0}),s.tryParseJSON=s.parseQueryString=s.hashFromString=s.isProductionBuild=s.simpleUnHash=s.simpleHash=s.atobShim=s.delayRandom=s.delay=s.tryParseInt=s.randomString=s.retryFetch=void 0;var i=t("./src/common/utils.ts");Object.defineProperty(s,"retryFetch",{enumerable:!0,get:function(){return i.retryFetch}}),Object.defineProperty(s,"randomString",{enumerable:!0,get:function(){return i.randomString}}),Object.defineProperty(s,"tryParseInt",{enumerable:!0,get:function(){return i.tryParseInt}}),Object.defineProperty(s,"delay",{enumerable:!0,get:function(){return i.delay}}),Object.defineProperty(s,"delayRandom",{enumerable:!0,get:function(){return i.delayRandom}});const o=t("./src/sdk/constants.ts");s.atobShim=e=>{let s="";try{if("string"==typeof(s=window.atob(e)))return s}catch(e){}s="";var t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";if(e=String(e).replace(/[\t\n\f\r ]+/g,""),!/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/.test(e))throw new TypeError("Failed to execute 'atob' on 'Window': The string to be decoded is not correctly encoded.");e+="==".slice(2-(3&e.length));let i,o,n,r=0;for(;r<e.length;)i=t.indexOf(e.charAt(r++))<<18|t.indexOf(e.charAt(r++))<<12|(o=t.indexOf(e.charAt(r++)))<<6|(n=t.indexOf(e.charAt(r++))),s+=64===o?String.fromCharCode(i>>16&255):64===n?String.fromCharCode(i>>16&255,i>>8&255):String.fromCharCode(i>>16&255,i>>8&255,255&i);return s},s.simpleHash=e=>window.btoa(JSON.stringify(e)),s.simpleUnHash=e=>(0,s.tryParseJSON)((0,s.atobShim)(e)),s.isProductionBuild=()=>"production"===o.ENV_NAME||"prod"===o.ENV_NAME,s.hashFromString=e=>{let s=5381,t=e.length;for(;t;)s=33*s^e.charCodeAt(--t);return s>>>0},s.parseQueryString=e=>{e=e.split("?").pop().split("&");let s={};try{for(var t of e){const i=t.split("=");i[0]&&(i[1]=i[1]?i[1].replace(/\+/gi," "):"",s[i[0]]=decodeURIComponent(i[1]))}}catch(e){}return s};s.tryParseJSON=e=>{let s;try{s=JSON.parse(e)}catch(e){}return s}}},i={};function p(e){var s=i[e];if(void 0!==s)return s.exports;s=i[e]={id:e,exports:{}};return t[e].call(s.exports,s,s.exports,p),s.exports}p.n=e=>{var s=e&&e.__esModule?()=>e.default:()=>e;return p.d(s,{a:s}),s},p.d=(e,s)=>{for(var t in s)p.o(s,t)&&!p.o(e,t)&&Object.defineProperty(e,t,{enumerable:!0,get:s[t]})},p.o=(e,s)=>Object.prototype.hasOwnProperty.call(e,s),p.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},p.nc=void 0;var l={};(()=>{"use strict";Object.defineProperty(l,"__esModule",{value:!0});var s=p("./src/sdk/exceptions/pushly.exception.ts");const e=p("./src/sdk/models/context.model.ts"),t=p("./src/sdk/sdk.ts"),i=p("./src/sdk/services/logging.service.ts");p("./src/sdk/styles/app.scss");try{const r=new t.SDK(new e.ContextModel);var o=window.PushlySDK;if(o&&o instanceof Array)for(var n of o)r.push(n);window.PushlySDK=r}catch(e){if(!(e instanceof s.PushlyException))throw e;console.log(e),i.Logger.warn("[pushly-sdk]",e.message)}})()})();
